...
![Git Download Options](images/Git_Download_Options.PNG "Git Download Options")
...
![Exe File Download](images/Exe_Download.PNG "Exe Download Screen")
...
![Code Button to Clone](images/Clone_Button.PNG "Code Button to Clone")

Open your Git Bash application you downloaded earlier. It should look something like this:

![Git Bash Example](images/Git_Bash_Example.PNG "Example of Git Bash on Opening")
...
![Git Bash Cloned Repository](images/Cloned_Repository_GitBash.PNG "Example of Cloned Repository")
