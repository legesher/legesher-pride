...
![Github Desktop Example](images/Github_Desktop_Example.PNG "Github Desktop Example")
...
![Get GitHub Desktop](images/Get_Github_Desktop.PNG "Get Github Desktop")
...
![GitHub Desktop Exe File](images/Github_Desktop_EXE.PNG "Github Desktop Exe File")
...
![Welcome to GitHub Desktop](images/Welcome_To_Github_Desktop.PNG "Welcome to Github Desktop)")
...
![Login Authorization](images/Github_Login_Authorization.PNG "GitHub Login Authorization")

After you choose the green Authorize desktop button, you will come to the let's get started page.

![Let's Get Started](images/Lets_Get_Started.PNG "Lets Get Started Page")
...
![Fork Button](images/Fork_Button.PNG "Fork Button")
...
![Forked Repository Path](images/Forked_Repository_Path.PNG "Forked Repository Path")
...
![Choosing a Repository to Clone](images/Choosing_Repository_To_Clone.PNG " Choosing a Repository to Clone")
...
![How are you planning to use this fork?](images/How_Are_You_Planning_To_Use_This_Fork.PNG "How are you planning to use this fork?")
